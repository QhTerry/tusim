...
export function getPlan(id) {
  if (id === 'custom') return { id:'custom', name:'Свой формат', price:null, durationHours:72, storageDays:180, watermark:false, features:{ zip:true, leaderboard:true, stats:true, moderation:true, live:true, cover:true } }
