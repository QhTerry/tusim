    ...
    <>
      <style>{`
        ...
        .nav-label {
          ...
          letter-spacing: 0.02em; color: #3a3a3a;
      ...
      <nav className="bottom-nav">
        {/* Голосование */}
        <a href="/swipe" className="nav-item">
          ...
          <a id="nav-camera-link" href="/event/loading" style={{ textDecoration: 'none', display: 'block' }}>
            <div className="nav-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M12 15.5A3.5 3.5 0 018.5 12 3.5 3.5 0 0112 8.5a3.5 3.5 0 013.5 3.5 3.5 3.5 0 01-3.5 3.5m7-10h-3l-2-2H10L8 5.5H5a2 2 0 00-2 2v11a2 2 0 002 2h14a2 2 0 002-2v-11a2 2 0 00-2-2z"
                  fill="white"
                />
              </svg>
            </div>
